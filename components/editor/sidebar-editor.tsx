...
export default function SidebarEditor() {
  ...
  // Abrir automaticamente quando um rascunho de comentário começa,
  // sem impedir o usuário de fechar manualmente a sidebar depois.
  React.useEffect(() => {
  ...
  }, [commentDraft, isMobile, setOpenMobile, setOpen]);
  ...
  return (
    <Sidebar side="right" variant="floating" collapsible="offcanvas">
      <SidebarContent className="overflow-x-hidden items-stretch">
        <SidebarGroup>
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
          ...
          {activeTab === "texto" ? (
            <div className="space-y-2">
              ...
              {!bibleLoading && !bibleError && !bibleText && (
                <div className="text-muted-foreground">
                  Selecione uma referência bíblica no texto para visualizar
                  aqui.
                </div>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {allBibleTexts.length === 0 ? (
                <div className="text-muted-foreground">
                  Nenhum texto bíblico encontrado nesta nota.
                </div>
              ) : (
                  ...
                  {comments.map((c) => (
                    ...
                    >
                      ...
                      <div
                        ...
                        title={c.excerpt}
                      >
                        <div className="text-xs text-muted-foreground mb-1 italic line-clamp-2">
                          {c.excerpt}
                        </div>
                        {editingId === c.id ? (
                          <div className="space-y-2">
